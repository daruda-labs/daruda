...
impl AssetSource for DarudaAssets {
    fn load(&self, path: &str) -> anyhow::Result<Option<Cow<'static, [u8]>>> {
        ...
        match path {
            ...
            "icons/ui/minimize.svg" => icon!("ui/minimize.svg"),
            "icons/ui/crop-square.svg" => icon!("ui/crop-square.svg"),
            "icons/ui/filter-none.svg" => icon!("ui/filter-none.svg"),
            "icons/ui/keyboard-arrow-up.svg" | "icons/chevron-up.svg" => {
                icon!("ui/keyboard-arrow-up.svg")
            }
            "icons/ui/keyboard-arrow-down.svg" => icon!("ui/keyboard-arrow-down.svg"),
            "icons/ui/expand-more.svg" | "icons/chevron-down.svg" => icon!("ui/expand-more.svg"),
            "icons/ui/arrow-back.svg" => icon!("ui/arrow-back.svg"),
            "icons/ui/arrow-forward.svg" => icon!("ui/arrow-forward.svg"),
            "icons/ui/keep-fill.svg" => icon!("ui/keep-fill.svg"),
            "icons/ui/fiber-manual-record.svg" => icon!("ui/fiber-manual-record.svg"),
            "icons/ui/check-box-outline-blank.svg" => icon!("ui/check-box-outline-blank.svg"),
            "icons/ui/check-box.svg" => icon!("ui/check-box.svg"),
            "icons/ui/indeterminate-check-box.svg" => icon!("ui/indeterminate-check-box.svg"),
            "icons/ui/refresh.svg" | "icons/refresh.svg" => icon!("ui/refresh.svg"),
            "icons/ui/open-in-full.svg" | "icons/maximize.svg" => icon!("ui/open-in-full.svg"),
            "icons/ui/chevron-right.svg" | "icons/chevron-right.svg" => {
            ...
            "icons/ui/content-copy.svg" | "icons/copy.svg" => icon!("ui/content-copy.svg"),
            "icons/ui/difference.svg" => icon!("ui/difference.svg"),
            "icons/ui/dock-to-bottom.svg" => icon!("ui/dock-to-bottom.svg"),
            "icons/ui/dock-to-bottom-fill.svg" => icon!("ui/dock-to-bottom-fill.svg"),
            "icons/ui/dock-to-left.svg" => icon!("ui/dock-to-left.svg"),
            "icons/ui/dock-to-left-fill.svg" => icon!("ui/dock-to-left-fill.svg"),
            "icons/ui/dock-to-right.svg" => icon!("ui/dock-to-right.svg"),
            "icons/ui/dock-to-right-fill.svg" => icon!("ui/dock-to-right-fill.svg"),
            ...
            "icons/ui/keep.svg" => icon!("ui/keep.svg"),
            "icons/ui/menu.svg" => icon!("ui/menu.svg"),
            ...
            "icons/ui/psychology.svg" => icon!("ui/psychology.svg"),
            ...
            "icons/ui/task-alt.svg" => icon!("ui/task-alt.svg"),
