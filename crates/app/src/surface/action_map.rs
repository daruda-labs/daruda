...
use crate::workspace::{
    ...
    RefreshGitStatus, ShowSidebarFiles, ShowSidebarGit, ShowSidebarWorktrees, SplitDown,
...
pub fn apply_keybinding_overrides(
    ...
    for (key, action_name) in bindings {
        ...
        bind!(key_str, name_str, cx,
            ...
            "show_sidebar_worktrees" => ShowSidebarWorktrees,
            "show_sidebar_git" => ShowSidebarGit,
            "show_sidebar_files" => ShowSidebarFiles,
