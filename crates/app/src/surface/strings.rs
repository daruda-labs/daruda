...
/// Metadata chip inside a subagent's always-visible instructions block naming
/// its type, e.g. "Type: general-purpose".
...
pub fn remove_lane_err_flow_elsewhere(pid: u32) -> String {
    rust_i18n::t!("modal.remove_lane_err_flow_elsewhere", pid => pid).into_owned()
}
...
pub fn bottom_input_queue_resume_armed(n: usize) -> String {
    rust_i18n::t!("bottom_dock.queue_resume_armed", n = n).into_owned()
}
...
pub fn control_flow_stop_already_idle() -> String {
    rust_i18n::t!("control.flow_stop_already_idle").into_owned()
}
