...
daruda_theme_fields! {
    ...
    worktree_card_bg => WORKTREE_CARD_BG,
    worktree_card_border => WORKTREE_CARD_BORDER,
    worktree_card_hover_bg => WORKTREE_CARD_HOVER_BG,
    worktree_card_active_bg => WORKTREE_CARD_ACTIVE_BG,
    worktree_row_active_bg => WORKTREE_ROW_ACTIVE_BG,
