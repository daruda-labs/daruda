...
daruda_theme_fields! {
    ...
    settings_scrollbar_thumb => DOCK_SCROLLBAR_THUMB,
    settings_scrollbar_thumb_hover => DOCK_SCROLLBAR_THUMB_HOVER,
    right_panel_scrollbar_thumb => DOCK_SCROLLBAR_THUMB,
    right_panel_scrollbar_thumb_hover => DOCK_SCROLLBAR_THUMB_HOVER,
    ...
    file_viewer_scrollbar_thumb => DOCK_SCROLLBAR_THUMB,
    file_viewer_scrollbar_thumb_hover => DOCK_SCROLLBAR_THUMB_HOVER,
    ...
    toast_action_text => ACCENT_GREEN,
    ...
    keystroke_input_border_active => ACCENT_GREEN,
    ...
    right_panel_task_running_color => ACCENT_GREEN,
    ...
    task_edit_branch_invalid_border => RIGHT_PANEL_TASK_ERROR_COLOR,
    badge_bg => BG_HOVER,
    badge_border => BORDER,
