...
daruda_theme_fields! {
    ...
    sidebar_view_tab_inactive => SIDEBAR_VIEW_TAB_INACTIVE,
    sidebar_view_tab_active => SIDEBAR_VIEW_TAB_ACTIVE,
    sidebar_view_tab_accent => SIDEBAR_VIEW_TAB_ACCENT,
    sidebar_view_tab_hover_bg => SIDEBAR_VIEW_TAB_HOVER_BG,
    worktree_accent_active => WORKTREE_ACCENT_ACTIVE,
