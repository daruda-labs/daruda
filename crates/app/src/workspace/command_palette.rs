...
pub(super) const PALETTE_ENTRIES: &[PaletteEntry] = &[
    PaletteEntry {
        id: "open_settings",
        label: "Settings…",
        shortcut: "Cmd+,",
    ...
    PaletteEntry {
        id: "open_settings.file_viewer",
        label: "Settings: File Viewer",
        shortcut: "",
    },
    PaletteEntry {
    ...
    PaletteEntry {
        id: "activate_worktree_1",
        label: "Activate Worktree 1",
        shortcut: "Cmd+Ctrl+1",
    },
    PaletteEntry {
        id: "activate_worktree_2",
        label: "Activate Worktree 2",
        shortcut: "Cmd+Ctrl+2",
    },
    PaletteEntry {
        id: "activate_worktree_3",
        label: "Activate Worktree 3",
        shortcut: "Cmd+Ctrl+3",
    },
    PaletteEntry {
        id: "activate_worktree_4",
        label: "Activate Worktree 4",
        shortcut: "Cmd+Ctrl+4",
    },
    PaletteEntry {
        id: "activate_worktree_5",
        label: "Activate Worktree 5",
        shortcut: "Cmd+Ctrl+5",
    },
    PaletteEntry {
        id: "activate_worktree_6",
        label: "Activate Worktree 6",
        shortcut: "Cmd+Ctrl+6",
    },
    PaletteEntry {
        id: "activate_worktree_7",
        label: "Activate Worktree 7",
        shortcut: "Cmd+Ctrl+7",
    },
    PaletteEntry {
        id: "activate_worktree_8",
        label: "Activate Worktree 8",
        shortcut: "Cmd+Ctrl+8",
    },
    PaletteEntry {
        id: "activate_worktree_9",
        label: "Activate Worktree 9",
        shortcut: "Cmd+Ctrl+9",
    },
    PaletteEntry {
...
impl RenderOnce for CommandPaletteOverlay {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let query_text = t.palette_query_text;
        let focused_bg = t.palette_focused_bg;
        let focused_text = t.palette_focused_text;
        let entry_text = t.palette_entry_text;
        let shortcut_text = t.palette_shortcut_text;
