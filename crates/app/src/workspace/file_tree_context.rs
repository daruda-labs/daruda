//! Sidebar Files-view state owned by [`super::Workspace`].
//!
...
use crate::workspace::file_tree_ops::{FilesReloadQueue, VisibleEntry};

pub(in crate::workspace) struct FileTreeContext {
    /// Per-worktree lazy file tree for the sidebar Files view. Created
    ...
    /// Mirror of `daruda_config::SidebarConfig::files_show_hidden`.
    ...
    /// Focus handle attached to the sidebar Files panel root. Click on
    ...
    /// Mirror of `daruda_config::SidebarConfig::files_use_gitignore`.
    ...
    /// Mirror of `daruda_config::SidebarConfig::file_icon_color_mode`.
    ...
    /// sidebar's scrollbar overlay. Cloning is cheap (shared `Rc`).
