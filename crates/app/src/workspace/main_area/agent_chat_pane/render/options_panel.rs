//! Shared helpers for the Activity Bar's transcript-axis controls — the
//! popover shell all three panels sit in, and the mark their chips carry.
...
#[cfg(test)]
mod tests {
    use super::{axis_chip_label, cap_to_viewport};
    use crate::ui::theme;
    use crate::workspace::main_area::agent_chat_pane::pane_choice::PaneChoice;
