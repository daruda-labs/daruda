...
impl Workspace {
    ...
    pub fn open_add_mcp_server_modal(
        ...
        super::tools::open_add_mcp_server_modal(self, prefill_scope, window, cx);
    }
    ...
    pub fn open_edit_mcp_server_modal(
        ...
        super::tools::open_edit_mcp_server_modal(self, scope, name, window, cx);
    }
    ...
    pub fn open_delete_mcp_server_confirm(
        ...
        super::tools::open_delete_mcp_server_confirm(self, scope, name, window, cx);
    }
}
