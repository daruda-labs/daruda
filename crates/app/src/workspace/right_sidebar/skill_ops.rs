...
//!
//! Thin shim layer that forwards to `super::skills::*`
...
impl Workspace {
    pub fn open_create_skill_modal(
        ...
        super::skills::open_create_skill_modal(self, prefill_scope, window, cx);
    }
    ...
    pub fn open_edit_skill_modal(
        ...
        super::skills::open_edit_skill_modal(self, dir, window, cx);
    }
    ...
    pub fn open_delete_skill_confirm(
        ...
        super::skills::open_delete_skill_confirm(self, scope, dir, window, cx);
    }
    ...
    pub fn open_rename_skill_modal(
        ...
        super::skills::open_rename_skill_modal(self, scope, dir, window, cx);
    }
