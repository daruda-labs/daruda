...
use crate::workspace::right_sidebar::skills::modal_shared::field_label;
...
/// `Workspace::open_create_skill_modal` shim — opens this modal
/// through the standard `ModalLayer` entry point.
