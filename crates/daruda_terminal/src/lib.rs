...
pub use config::{
    CursorShape, DEFAULT_FONT_SIZE, DEFAULT_INSET_X, DEFAULT_INSET_Y, DEFAULT_SPACING,
    FONT_SIZE_MAX, FONT_SIZE_MIN, INSET_MAX, INSET_MIN, PromptJumpScroll, SPACING_MAX, SPACING_MIN,
